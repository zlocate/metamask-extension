  ...
  switch (props.response.status) {
    case 'no_deposits':
      return h('.flex-column', {
        ...
        }, this.t('toETHviaShapeShift', [props.depositType])),
        h('div', this.t('noDeposits')),
        h('div', {
          style: {
            fontSize: 'x-small',
            color: '#ABA9AA',
    ...
    case 'received':
      return h('.flex-column', {
        ...
        h('div', this.t('conversionProgress')),
        h('div', {
          style: {
            fontSize: 'x-small',
            color: '#ABA9AA',
    ...
    case 'failed':
      return h('span.error', '(' + this.t('failed') + ')')
    default:
      return ''
  }
}
