...
const facuetRowText = (networkName) => {
  return this.t('getEtherFromFaucet', [networkName])
}
...
function DepositEtherModal () {
  ...
  DIRECT_DEPOSIT_ROW_TITLE = this.t('directDepositEther')
  DIRECT_DEPOSIT_ROW_TEXT = this.t('directDepositEtherExplainer')
  COINBASE_ROW_TITLE = this.t('buyCoinbase')
  COINBASE_ROW_TEXT = this.t('buyCoinbaseExplainer')
  SHAPESHIFT_ROW_TITLE = this.t('depositShapeShift')
  SHAPESHIFT_ROW_TEXT = this.t('depositShapeShiftExplainer')
  FAUCET_ROW_TITLE = this.t('testFaucet')
...
DepositEtherModal.prototype.render = function () {
  ...
  return h('div.page-container.page-container--full-width.page-container--full-height', {}, [
    ...
    h('div.page-container__header', [
      ...
      h('div.page-container__title', [this.t('depositEther')]),

      h('div.page-container__subtitle', [
        this.t('needEtherInWallet'),
      ]),
    ...
    h('.page-container__content', {}, [
      ...
      h('div.deposit-ether-modal__buy-rows', [
        ...
        this.renderRow({
          ...
          buttonLabel: this.t('viewAccount'),
        ...
        this.renderRow({
          ...
          buttonLabel: this.t('continueToCoinbase'),
        ...
        this.renderRow({
          ...
          buttonLabel: this.t('shapeshiftBuy'),
